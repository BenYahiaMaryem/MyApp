...
export default class Items extends Component {
  ...
  state={hasError: false,
    ...
    getData(){
      ...
      return fetch('http://localhost:5000/retrieveSimilar/'+this.props.item,
      {
        method: 'GET',
        headers: {
            'Accept': 'application/json',
    ...
    //this.sendData()
      ...
      render() {
        ...
        return (
            ...
            <Navbar left={left} right={right} title={this.props.item} />
                  ...
                  <View  style={{alignContent : 'stretch',width : 160}}>
                            ...
                            <Image source={{ uri: 'data:image/jpeg;base64,'+item.imageDecoded}} style={{height : 200,width : null,resizeMode : 'cover'}} />
                                <TouchableOpacity style={{alignItems : 'flex-end',justifyContent : 'center',position : 'absolute',top : 10,right :  10 }}>
                                    <LikeButton val={item._id.$oid} valeur={item.type} />
                                </TouchableOpacity>
